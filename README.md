...
Утилита для анализа дискового пространства и очистки системы.
...
### Возможности
- **Анализ диска** - статистика использования, топ папок и файлов
- **Анализ RAM** - использование памяти, топ процессов, swap, Docker контейнеры
- **Анализ Docker** - размер образов, контейнеров, логов
- **Анализ логов** - системные логи, journald
- **Анализ кешей** - apt, pip, snap
- **Рекомендации** - автоматические советы по очистке
- **Безопасная очистка** - автоматическая очистка без потери данных
- **Генерация отчетов** - полный отчет в файл

### Меню
```
1. Полный анализ диска
...
8. Безопасная очистка (автоматическая)
9. Сгенерировать полный отчет
0. Выход
```

### Анализ памяти показывает:
- Общую статистику RAM (всего/использовано/свободно)
- Топ-20 процессов по использованию памяти
- Топ-10 процессов по реальной памяти (RSS)
- Информацию о swap и процессах его использующих
- Использование памяти Docker контейнерами
- Рекомендации при высоком потреблении
